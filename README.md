...
- 錯題自動進錯題本，按艾賓浩斯（30分→1天→2天→4天→7天→15天→30天→90天，連對8次牢固）在「復盤中心」排隊
...
本專案為作者個人著作，受著作權法保護。**未經作者事先書面同意，禁止複製、鏡像、重新託管、改作散布或作任何商業用途**，亦不得移除本署名。詳見 [LICENSE](LICENSE)。

- 官方唯一網址：**https://iamamilycc.github.io/jingdu**
- 允許：個人／家庭／非營利的直接使用。
- 其他任何網址若出現相同或高度相似內容，均非作者發布，請勿信任。
- 授權洽詢：GitHub @iamamilycc。
